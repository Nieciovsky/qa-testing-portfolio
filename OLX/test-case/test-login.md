...
1. [Logowanie z niepoprawnym formatem e-mail (brak @)](#TC_OLX_LOGIN_005)
2. [Logowanie z niepoprawnym formatem e-mail (brak domeny)](#TC_OLX_LOGIN_006)
3. [Logowanie z nieistniejącym adresem e-mail](#TC_OLX_LOGIN_007)
4. [Próba logowania bez podania adresu e-mail](#TC_OLX_LOGIN_008)
5. [Spacje przed / po adresie e-mail (trimowanie)](#TC_OLX_LOGIN_009)
## 3. Walidacja danych wejściowych – hasło
1. [Logowanie z niepoprawnym hasłem](#TC_OLX_LOGIN_010)
2. [Próba logowania bez podania hasła](#TC_OLX_LOGIN_011)
3. [Hasło z dodatkowymi spacjami (na początku / końcu)](#TC_OLX_LOGIN_012)
4. [Widoczność znaków hasła (maskowanie)](#TC_OLX_LOGIN_013)
## 4. Komunikaty błędów (UX / UI)
1. [Wyświetlenie komunikatu błędu przy niepoprawnych danych](#TC_OLX_LOGIN_014)
2. [Czy komunikat błędu znika po poprawieniu danych](#TC_OLX_LOGIN_015)
## 5. Przycisk „Zaloguj” i elementy formularza
1. [Przycisk „Zaloguj” nieaktywny przy pustych polach](#TC_OLX_LOGIN_016)
2. [Przycisk „Zaloguj” aktywny po uzupełnieniu danych](#TC_OLX_LOGIN_017)
3. [Widoczność i dostępność linku „Nie pamiętam hasła”](#TC_OLX_LOGIN_018)
...
*Bug Report:* [Click Here](OLX/bug-reports/trim-password.md)
